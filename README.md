...
* [JFinal](https://github.com/jfinal/jfinal)：JFinal是基于Java语言的极速WEB + ORM框架，其核心设计目标是开发迅速、代码量少、学习简单、功能强大、轻量级、易扩展、Restful。
...
* [Eclipse Jersey](https://github.com/eclipse-ee4j/jersey)：Eclipse基金会下的REST框架，提供JAX-RS等参考实现。
* [Dropwizard](https://github.com/dropwizard/dropwizard)：一个非常简单的库，用于构建生产就绪的REST Web服务。
* [RESTEasy](https://github.com/resteasy/resteasy)：RESTEasy是一个 JBoss项目，旨在为使用Java开发客户端和服务器RESTful应用程序和服务提供生产力框架。
...
* [Spring Data JPA](https://github.com/spring-projects/spring-data-jpa)：Spring中用于简化JPA开发的项目。
* [Mybatis](https://github.com/mybatis/mybatis-3)：Java的MyBatis SQL 映射框架。
* [Mybatis-Plus](https://github.com/baomidou/mybatis-plus)：MyBatis强大的增强工具包，简化开发。
...
* [Apache OpenJPA](https://github.com/apache/openjpa)：Apache基金会下的JPA实现。
...
* [Jimmer](https://github.com/babyfish-ct/jimmer)：针对Java和Kotlin的革命性ORM。
...
* [Querydsl](https://github.com/OpenFeign/querydsl)：Querydsl是一个框架，可以为多个后端(包括JPA、MongoDB和Java中的SQL)构建类型安全的类SQL查询。
...
* [Gaea](https://github.com/58code/Gaea)：跨平台、高性能、高可用中间层服务框架，58同城开源。
* [YMP](https://github.com/suninformation/ymate-platform-v2)：一个非常简单、易用的轻量级Java应用开发框架。
...
* [Apache Usergrid](https://github.com/apache/usergrid)：基于RESTful API的用于Web和移动应用程序的多租户后端即服务堆栈。
...
* [Apiary](https://github.com/DBOS-project/apiary)：Apiary是一个事务性功能即服务(FaaS)框架，用于构建面向数据库的应用程序，例如微服务和Web服务后端，这是MIT-Stanford DBOS合作的一个研究项目。
...
* [Apache Dubbo](https://github.com/apache/dubbo)：阿里开源的RPC和微服务框架。
...
* [Spring Cloud AWS](https://github.com/awspring/spring-cloud-aws)：AWS提供的Spring Cloud框架。
...
* [Apache ServiceComb](https://github.com/apache/servicecomb-java-chassis)：华为云开源的软件开发套件，用于快速开发Java微服务。
* [Axon](https://github.com/AxonFramework/AxonFramework)：一个基于DDD、CQRS和事件溯源原则构建渐进式事件驱动微服务系统的框架。
* [Misk](https://github.com/cashapp/misk)：允许你使用Kotlin或Java快速创建微服务，并提供用于常见问题的库，例如服务端点、缓存、队列、持久层、分布式租赁和集群。
...
* [Apache JClouds](https://github.com/apache/jclouds)：一个适用于Java平台的开源多云工具包，可让你自由地创建可跨云移植的应用程序，同时让你完全控制使用特定于云的功能。
...
* [Prana](https://github.com/Netflix/Prana)：用于基于NetflixOSS的服务的Sidecar，由Netflix开源。
* [Sermant](https://github.com/huaweicloud/Sermant)：基于Java Agent的无代理服务网格解决方案，由华为开源。
...
* [Hikaku](https://github.com/codecentric/hikaku)：用于测试REST-API的实现是否满足其规范的库。
...
* [Mu2](https://github.com/cmu-pasta/mu2)：Mu2是一个用于突变引导模糊测试的模糊测试平台，构建在用于模糊Java程序的JQF平台之上。
* [EvoMaster](https://github.com/EMResearch/EvoMaster)：开源人工智能驱动工具，用于为Web/企业应用程序自动生成系统级测试用例(也称为模糊测试)。
...
* [Caliper](https://github.com/google/caliper)：用于测量Java代码性能的工具，主要侧重于微基准测试，由Google开源。
...
* [kraken](https://github.com/OctoPerf/kraken)：Kraken是一个基于Gattle的负载测试IDE。
...
* [Hypothesis-Java](https://github.com/HypothesisWorks/hypothesis-java)：针对Java的高级基于属性的测试系统。
...
* [FitNesse](https://github.com/unclebob/fitnesse)：这是一个完全集成的独立验收测试框架和wiki。
...
* [Diffy](https://github.com/opendiffy/diffy)：Diffy使用并排运行新代码和旧代码的实例来发现服务中的潜在错误。
...
* [Testable-Mock](https://github.com/alibaba/testable-mock)：阿里开发的Mock框架。
...
* [AnyMock](https://github.com/duxiaoman/AnyMock)：度小满开源的通用接口Mock平台。
...
* [Freud](https://github.com/LMAX-Exchange/freud)：用于编写静态分析测试的框架。
...
* [Apache Mvnd](https://github.com/apache/maven-mvnd)：提供更快的Maven构建。
...
* [Polyglot Maven](https://github.com/takari/polyglot-maven)：允许使用XML以外的方言编写POM模型。
...
* [AndroidIDE](https://github.com/AndroidIDEOfficial/AndroidIDE)：用于在Android设备上开发真实的、基于Gradle的Android应用程序的IDE。
...
* [Atlassian Confluence](https://www.atlassian.com/zh/software)：Confluence是一款建基于Web企业维基的软件，由澳洲软件公司Atlassian所开发。
* [MyCollab](https://github.com/MyCollab/mycollab)：免费的开源项目管理软件。
* [GanttProject](https://github.com/bardsoftware/ganttproject)：开源、免费、高性能、稳定、安全的项目管理和文档Java应用业务平台。
...
* [Gerrit](https://github.com/GerritCodeReview/gerrit)：基于Git的项目的代码审查和项目管理工具，由Google开源。
...
* [Serverless Java Container](https://github.com/awslabs/aws-serverless-java-container)：用于在AWS Lambda中运行Spring、Jersey、Spark和其他应用程序的Java包装器。
* [Spring Cloud Function](https://github.com/spring-cloud/spring-cloud-function)：基于Spring Boot的函数计算框架。
* [Apache OpenWhisk](https://github.com/apache/openwhisk)：Apache OpenWhisk是一个开源Serverless云平台，由IBM开源。
...
* [Argus](https://github.com/salesforce/Argus)：一个时序监控和警报平台，它由离散服务组成，用于配置警报、摄取和转换指标和事件、发送通知、创建命名空间以及建立和实施策略和使用配额，由Salesforce开源。
...
* [Blueflood](https://github.com/rax-maas/blueflood)：一个多租户、分布式度量处理系统，能够大规模地摄取、汇总和提供指标，由Rackspace开源。
...
* [Riemann JVM Profiler](https://github.com/riemann/riemann-jvm-profiler)：JVM代理，将功能级探查器遥测数据发送到Riemann服务器以进行分析、可视化和存储。
* [Perf Map Agent](https://github.com/jvm-profiling-tools/perf-map-agent)：一个Java代理，用于生成与Linux perf工具一起使用的方法映射。
* [MAT](https://eclipse.dev/mat/)：一款快速且功能丰富的Java堆分析器，可帮助你查找内存泄漏并减少内存消耗。
* [Heapster](https://github.com/mariusae/heapster)：JVM的生产堆分析，与谷歌性能工具兼容。
...
* [Apache Calcite](https://github.com/apache/calcite)：动态数据管理框架。
...
* [Apache Celeborn](https://github.com/apache/incubator-celeborn)：一种弹性且高性能的服务，用于洗牌和溢出数据，由阿里云开源。
* [Apache CarbonData](https://github.com/apache/carbondata)：高性能数据存储解决方案，由华为开源。
* [Apache Kyuubi](https://github.com/apache/kyuubi)：Kyuubi是一个分布式多租户网关，用于在数据仓库和Lakehouse上提供无服务器SQL，由网易开源。
...
* [Airbyte](https://github.com/airbytehq/airbyte)：用于从API、数据库和文件到仓库和湖泊的ELT管道的数据集成平台。
* [Fire](https://gitee.com/fire-framework/fire)：Fire框架是由中通大数据自主研发并开源的、专门用于进行Spark和Flink任务开发的大数据框架。
* [Apache OODT](https://github.com/apache/oodt)：Apache OODT可以实现数据库链接、工作流处理以及硬件/文件管理等功能，美国国家航空和宇航局的喷气机推力研究室开源。
...
* [AutoMQ](https://github.com/AutoMQ)：Kafka和RocketMQ的云原生实现。
...
* [JoyQueue](https://github.com/jd-opensource/joyqueue)：一个性能卓越的云原生生产就绪消息平台，由京东开源。
* [HornetQ](https://github.com/hornetq/hornetq)：用于构建多协议、可嵌入、高性能、集群、异步消息传递系统的开源项目，JBoss社区开发。
* [XXL-MQ](https://gitee.com/xuxueli0323/xxl-mq)：XXL开源的分布式消息队列。
...
* [ElasticMQ](https://github.com/softwaremill/elasticmq)：ElasticMQ是一个消息队列系统，提供基于Actor的Scala和SQS兼容的REST接口。
...
* [DeFiBus](https://github.com/WeBankFinTech/DeFiBus)：基于开源消息中间件打造的安全可控的分布式金融级消息总线，由微众开源。
* [Deezpatch](https://github.com/joel-jeremy/deezpatch)：简单、轻量级且高性能的调度库，用于解耦消息(请求和事件)和消息处理程序。
* [Ytk-mp4j](https://github.com/kanyun-inc/ytk-mp4j)：Ytk-mp4j是一个快速、用户友好、跨平台、多进程、多线程的集体消息传递Java库，用于分布式机器学习。
...
* [CMAK](https://github.com/yahoo/CMAK)：CMAK是管理Apache Kafka集群的工具，Yahoo开源。
...
* [Apache Curator](https://github.com/apache/curator)：ZooKeeper的Java/JVM客户端库。
...
* [FastUUID](https://github.com/jchambers/fast-uuid)：个用于快速有效地解析和写入UUID的Java库。
...
* [Lemur](https://sourceforge.net/projects/lemur/)：Lemur是CMU开发的著名搜索引擎。
...
* [QuestDB](https://github.com/questdb/questdb)：用于快速摄取和SQL查询的开源时序数据库。
...
* [Atlas](https://github.com/Netflix/atlas)：内存中维度时序数据库，由Netflix开源。
...
* [FiloDB](https://github.com/filodb/FiloDB)：分布式、与Prometheus兼容、实时、内存、可大规模扩展、多模式时序/事件/操作数据库。
...
* [QuickIO](https://github.com/artbits/quickio)：QuickIO是一个Java嵌入式数据库。
...
* [YoctoDB](https://github.com/yandex/yoctodb)：一个微型嵌入式Java引擎，用于极快的分区构建后不可变数据库。
...
* [Sparkey](https://github.com/spotify/sparkey-java)：Sparkey键值存储的Java实现，用作嵌入其他软件中的库，Spotify开源。
...
* [VoltDB](https://github.com/DBOS-project/voltdb)：VoltDB是一个分布式、水平可扩展、符合ACID的数据库。
...
* [Lealone](https://github.com/lealone/Lealone)：Lealone是一个高性能的面向OLTP场景的关系数据库。
...
* [Simbase](https://github.com/guokr/simbase)：Simbase是一个类似Redis的向量相似度数据库，果壳科技开源。
...
* [Guice](https://github.com/google/guice)：适用于Java 8及更高版本的轻量级依赖注入框架，由Google提供。
* [Dagger](https://github.com/google/dagger)：适用于Android和Java的快速依赖注入器，由Google开源。
...
* [Apache OpenWebBeans](https://github.com/apache/openwebbeans)：CDI 2.0规范的实现。
* [Eclipse Sisu](https://github.com/eclipse/sisu.inject)：基于JSR 330的模块化容器，支持类路径扫描、自动绑定和动态自动装配。
...
* [BizLog](https://github.com/mouzt/mzt-biz-log)：Spring Boot注解通用操作日志组件。
...
* [Guava Cache](https://github.com/google/guava/tree/master/guava/src/com/google/common/cache)：Guava库提供的Java本地缓存工具。
...
* [KCache](https://github.com/rayokota/kcache)：由Kafka支持的内存缓存。
* [Cache4j](https://cache4j.sourceforge.net/)：Java对象的缓存，简单的API和快速的实现。
* [Imcache](https://github.com/Cetsoft/imcache)：Java缓存库，旨在通过提供管理缓存数据的方法来加速应用程序。
...
* [LMAX Collections](https://github.com/LMAX-Exchange/LMAXCollections)：高性能集合库。
...
* [Kotlin Coroutines](https://github.com/Kotlin/kotlinx.coroutines)：Kotlin协程库。
...
* [AsyncTool](https://gitee.com/jd-platform-opensource/asyncTool)：多线程编排一站式解决方案，来自于京东主App后台。
* [Kilim](https://github.com/kilim/kilim)：Java的轻量级线程，具有消息传递、NIO、HTTP和调度支持。
* [EA Async](https://github.com/electronicarts/ea-async)：EA Async在JVM上实现Async/Await，允许程序员以顺序方式编写异步代码，艺电开源。
...
* [Concurrentli](https://github.com/linkedin/concurrentli)：扩展了java.util.concurrent的多线程类，为多线程Java程序增加了便利性、效率和新工具，LinkedIn开源。
...
* [CompletableFuture Fu](https://github.com/foldright/cffu)：Java 8 CompletableFuture辅助增强库。
...
* [Futures-Extra](https://github.com/spotify/futures-extra)：Futures-Extra是一组小型实用函数，用于简化Guava的ListenableFuture类的使用，Spotify开源。
...
* [XXL-Conf](https://github.com/xuxueli/xxl-conf)：XXL-Conf是一个轻量级分布式配置管理平台。
...
* [ConfigMe](https://github.com/AuthMe/ConfigMe)：适用于任何Java项目的简单配置管理库。
...
* [OWNER](https://github.com/matteobaccan/owner)：一个用于简化Java属性文件使用的API。
...
* [Simple YAML](https://github.com/Carleslc/Simple-YAML)：此Java API提供了一种易于使用的方式来存储数据并使用YAML格式提供配置。
...
* [Activiti](https://github.com/Activiti/Activiti)：Activiti是一个轻量级工作流程和BPM平台，面向业务人员、开发人员和系统管理员。
* [Flowable](https://github.com/flowable/flowable-engine)：为开发人员、系统管理员和业务用户提供紧凑且高效的工作流程和BPM平台。
* [Camunda](https://github.com/camunda/camunda-bpm-platform)：使用BPMN和DMN实现工作流程和决策自动化的灵活框架，与Quarkus、Spring、Spring Boot、CDI集成。
* [Apache DolphinScheduler](https://github.com/apache/dolphinscheduler)：DolphinScheduler是现代数据编排平台，以低代码敏捷创建高性能工作流程，由易观开源。
* [jBPM](https://github.com/kiegroup/jbpm)：jBPM是一个用于构建业务应用程序以帮助自动化业务流程和决策的工具包。
...
* [Bulbasaur](https://github.com/alibaba/bulbasaur)：阿里开源的可插拔精简流程引擎，可快速实现流程、审批、业务失败重试等场景。
* [SmartEngine](https://github.com/alibaba/SmartEngine)：SmartEngine是一个轻量级的业务编排引擎，在阿里巴巴集团被广泛使用。
...
* [Temporal](https://temporal.io/)：微服务编排平台，源自Cadence，但基于gRPC。
* [AgileBPM](https://gitee.com/agile-bpm/agile-bpm-basic)：快速、简洁且强大的低代码流程开发平台，国产开源。
* [Schedulis](https://github.com/WeBankFinTech/Schedulis)：Schedulis是一个基于LinkedIn的开源项目Azkaban开发的工作流任务调度系统。
...
* [Flowret](https://github.com/americanexpress/unify-flowret)：一个基于Java的轻量级编排引擎，由美国运通开源。
* [TestHub](https://gitee.com/dromara/TestHub)：一款基于流程编排的自动化测试工具，由dromara社区开源。
* [FlowLong](https://gitee.com/aizuda/flowlong)：国产开源的工作流引擎，爱组搭开源。
...
* [COPPER](https://github.com/copper-engine/copper-engine)：COPPER是一个开源、强大、轻量且易于配置的工作流引擎。
...
* [Apache PDFBox](https://github.com/apache/pdfbox)：Apache下用于处理PDF文档的开源Java工具。
...
* [Tabula](https://github.com/tabulapdf/tabula-java)：从PDF文件中提取表格的工具库。
...
* [Java WkHtmlToPdf Wrapper](https://github.com/jhonnymertz/java-wkhtmltopdf-wrapper)：wkhtmltopdf的Java包装器。
* [EasyTable](https://github.com/vandeseer/easytable)：基于Apache PDFBox构建的小项目，允许以相当简单的方式创建表格。
* [Sejda](https://github.com/torakiki/sejda)：用Java编写的可扩展且可配置的PDF操纵层库。
* [Pdf2Dom](https://github.com/radkovo/Pdf2Dom)：Pdf2Dom是一个PDF解析器，可将文档转换为HTML DOM表示形式。
* [HTMLToPDF-Java](https://github.com/wooio/htmltopdf-java)：一个用Java编写的HTML到PDF转换库，基于wkhtmltopdf。
* [PDF-Util](https://github.com/vinsguru/pdf-util)：PDF比较工具库。

#### Excel库

* [Apache POI](https://github.com/apache/poi)：用于读写Office二进制和OOXML文件格式的Java库。
...
* [Xcelite](https://github.com/eBay/xcelite)：Xcelite是一个类似ORM的Java库，它允许你轻松地将Javabean序列化到Excel电子表格或从Excel电子表格反序列化Java bean，由eBay开源。
...
* [Toml4j](https://github.com/mwanji/toml4j)：Java TOML解析库。
...
* [TomlJ](https://github.com/tomlj/tomlj)：TOML的Java解析器。
...
* [oj!Algorithms](https://github.com/optimatika/ojAlgo)：ojAlgo是用于数学、线性代数和优化的开源Java代码。
...
* [Apache OpenNLP](https://github.com/apache/opennlp)：一个基于机器学习的工具包，用于处理自然语言文本。
...
* [Similarity](https://github.com/shibing624/similarity)：文本相似度计算工具包，可用于文本相似度计算、情感分析等任务。
* [Jcseg](https://gitee.com/lionsoul/jcsegg)：Jcseg是一个用Java开发的轻量级NLP框架。
...
* [Apache UIMA](https://github.com/apache/uima-uimaj)：分析大量非结构化信息以发现与最终用户相关的知识的软件系统。
* [Apache cTAKES](https://github.com/apache/ctakes)：一个用于临床文本的自然语言处理平台。
* [Phrasal](https://github.com/stanfordnlp/phrasal)：用Java编写的大型统计机器翻译系统，由斯坦福开源。
...
* [Cornell SPF](https://github.com/lil-lab/spf)：康奈尔语义分析框架。
...
* [jMetal](https://github.com/jMetal/jMetal)：jMetal是一个基于Java的框架，用于使用元启发式进行多目标优化。
...
* [JavaSMT](https://github.com/sosy-lab/java-smt)：JavaSMT是用于访问各种SMT求解器的通用API层。
...
* [Apfloat](https://github.com/mtommila/apfloat)：Apfloat是一个高性能任意精度算术库。
...
* [NM Dev](https://nm.dev/)：NM Dev是一个面向对象、高性能、经过广泛测试且有专业文档记录的数学编程库。
...
* [Hipparchus](https://github.com/Hipparchus-Math/hipparchus)：Java编程语言中的高效通用数学组件库。
* [Universal Java Matrix Package](https://github.com/ujmp/universal-java-matrix-package)：用于稀疏和稠密矩阵、线性代数、可视化和大数据的Java库。
* [SSJ](https://github.com/umontreal-simul/ssj)：SSJ是一个用于随机模拟的Java库，在蒙特利尔大学计算机科学与运筹研究系模拟与优化实验室的Pierre L'Ecuyer的监督下开发。
* [Matrix-Toolkits-Java](https://github.com/fommil/matrix-toolkits-java)：MTJ是一个用于开发线性代数应用程序的高性能库。
* [NetLib-Java](https://github.com/fommil/netlib-java)：高性能线性代数库。
...
* [BigDecimal Utils](https://github.com/mortezaadi/bigdecimal-utils)：比较BigDecimal的工具库。
...
* [OWL API](https://github.com/owlcs/owlapi)：OWL API是用于创建、操作和序列化OWL本体的Java API。
* [Apache Jena](https://github.com/apache/jena)：Apache Jena是一个免费的开源Java框架，用于构建语义Web和链接数据应用程序。
...
* [Ontop](https://github.com/ontop/ontop)：Ontop是一个虚拟知识图谱系统，它将任意关系数据库的内容公开为知识图。
* [Scowl](https://github.com/phenoscape/scowl)：Scowl提供了Scala DSL，允许使用OWL API以声明式方法编写OWL表达式和公理。
* [DL-Learner](https://github.com/SmartDataAnalytics/DL-Learner)：DL-Learner是一个用于执行丰富语义背景知识的机器学习框架。
...
* [Openllet](https://github.com/Galigator/openllet)：Openllet是Java中的OWL 2推理器，构建在Pellet之上，由巴黎第十一大学开源。
* [ELK](https://github.com/liveontologies/elk-reasoner)：ELK是一个基于Java的OWL 2 EL推理器。
...
* [OBOGraphs](https://github.com/geneontology/obographs)：包含用于本体交换的JSON/YAML格式规范，以及Java对象模型和OWL转换器参考。
* [Ontmalizer](https://github.com/srdc/ontmalizer)：Ontmalizer自动执行XML模式(XSD)和XML数据到RDF/OWL的全面转换。
* [O'FAIRe](https://github.com/agroportal/fairness)：该项目是本体、词汇和语义资源的FAIRness评估工具。
...
* [ONT-API](https://github.com/owlcs/ont-api)：ONT-API是一个以RDF为中心的Java库，可与OWL2配合使用。
...
* [Eclipse RDF4J](https://github.com/eclipse-rdf4j/rdf4j)：一个强大的Java框架，用于处理和处理RDF数据，这包括使用RDF和链接数据创建、解析、可扩展存储、推理和查询。
...
* [MZmine 3](https://github.com/mzmine/mzmine3)：MZmine是一款用于质谱数据处理的开源软件。
* [Eclipse ChemClipse](https://github.com/eclipse/chemclipse)：Eclipse ChemClipse项目提供化学信息学和生物信息学领域的数据读取和处理功能。
* [JNBIS](https://github.com/mhshams/jnbis)：NIST生物识别图像软件(NBIS)的Java实现。
...
* [BridgeDb](https://github.com/bridgedb/BridgeDb)：BridgeDb是一个在各种生物数据库和相关资源之间映射标识符的框架。
...
* [PharmCAT](https://github.com/PharmGKB/PharmCAT)：一种从遗传数据集(以VCF文件表示)中提取所有CPIC指南基因变异、解释变异等位基因并生成报告的工具。
* [NGB](https://github.com/epam/NGB)：一种基于Web的NGS数据查看器，具有独特的结构变异(SV)可视化功能、高性能、可扩展性和云数据支持。
* [Cellbase](https://github.com/opencb/cellbase)：Cellbase是一个集中式数据库，集成了来自多个主要基因组和生物数据库的大量信息，用于基因组注释和临床变异优先级排序。
* [VarSim](https://github.com/bioinform/varsim)：用于癌症应用的高通量基因组测序的高保真模拟验证框架。
...
* [HummerRisk](https://github.com/HummerRisk/HummerRisk)：开源的云原生安全平台，核心能力包括混合云的安全治理和云原生安全检测。
* [Mariana Trench](https://github.com/facebook/mariana-trench)：适用于Android和Java应用程序的安全静态分析工具，由Facebook开源。
...
* [OpenRASP](https://github.com/baidu/openrasp)：OpenRASP是百度推出的开源自适应安全产品。
* [Okta](https://github.com/okta/okta-spring-boot)：Okta Spring Boot Starter。
* [OWASP ESAPI Java](https://github.com/ESAPI/esapi-java-legacy)：一个免费、开源的Web应用程序安全控制库，使程序员可以更轻松地编写风险较低的应用程序。
...
* [Janssen](https://github.com/JanssenProject/jans)：Janssen是一个可扩展的开源数字身份平台。
...
* [zxcvbn4j](https://github.com/nulab/zxcvbn4j)：这是zxcvbn的Java端口，zxcvbn是一个JavaScript密码强度生成器。
...
* [OWASP Java HTML Sanitizer](https://github.com/owasp/java-html-sanitizer)：一个用Java编写的快速且易于配置的HTML Sanitizer，可让你在Web应用程序中包含第三方编写的HTML，同时防止XSS。
* [Rhizobia_J](https://github.com/momosecurity/rhizobia_J)：Java安全SDK及编码规范，陌陌安全团队开源。
...
* [Apache Syncope](https://github.com/apache/syncope)：用于管理企业环境中的数字身份的开源系统，采用Java EE技术实现。
...
* [Easy-Security](https://gitee.com/aizuda/easy-security)：基于过滤器实现的一款配合Spring快速开发的安全认证框架，爱组搭开源。
...
* [XXL-SSO](https://gitee.com/xuxueli0323/xxl-sso)：分布式单点登录框架。
...
* [Topaz](https://www.topaz.sh/)：支持RBAC、ABAC和ReBAC的应用程序细粒度授权。
...
* [Apache Velocity](https://github.com/apache/velocity-engine)：用Java编写的通用模板引擎。
...
* [Bull](https://github.com/ExpediaGroup/bull)：一种Java Bean到Java Bean转换器，通用、灵活、可重用、可配置，并且速度非常快，由Expedia开源。
...
* [JMXTerm](https://github.com/jiaqi/jmxterm)：交互式命令行JMX客户端。
* [Cloud](https://github.com/Incendo/cloud)：Cloud是一个通用Java命令调度程序和框架。它允许程序员定义命令链，然后从用户提供的字符串输入中解析和调用这些命令链，以执行预定义的操作。
* [Argparse4j](https://github.com/argparse4j/argparse4j)：Java命令行参数解析器库。
* [JaCoLine](https://github.com/chriswhocodes/JaCoLine)：为开发人员提供有用的工具来理解和验证他们的Java命令行选项。
* [Docopt.Java](https://github.com/docopt/docopt.java)：Docopt的Java移植版本。
* [cURL](https://github.com/libetl/curl)：Java使用cURL的库。
...
* [JewelCLI](https://github.com/lexicalscope/jewelcli)：Java程序的命令行解析库。
* [CmdOption](https://github.com/ToToTec/CmdOption)：CmdOption是一个简单的注解驱动的命令行解析器工具包，适用于通过注解配置的Java 6+应用程序。
* [Barclay](https://github.com/broadinstitute/barclay)：Barclay是一组用于注释、解析、验证和生成命令行选项文档的类。
...
* [Apache Batik](https://github.com/apache/xmlgraphics-batik)：基于Java的工具包，适用于处理SVG格式的图像各种目的，例如观看、生成或操纵。
...
* [JImageHash](https://github.com/KilianB/JImageHash)：用于匹配相似图像的感知图像哈希库。
* [Image Scaling](https://github.com/mortennobel/java-image-scaling)：Java图像缩放库。
...
* [Cantaloupe](https://github.com/cantaloupe-project/cantaloupe)：Java高性能动态图像服务器。
* [Open Imaging](https://github.com/DhyanB/Open-Imaging)：用于图像创建和处理的工具和库。
...
* [Apache Nutch](https://github.com/apache/nutch)：一个可扩展且可伸缩的爬虫库。
...
* [Apache ManifoldCF](https://github.com/apache/manifoldcf)：一个多仓库爬虫框架，具有多个连接器。
...
* [Weixin SDK](https://github.com/borball/weixin-sdk)：微信公众平台(订阅号、服务号、企业号、小程序)、微信开放平台和微信支付Java SDK。
...
* [Stripe](https://github.com/stripe/stripe-java)：官方Stripe Java客户端库。
...
* [Cassandre](https://github.com/cassandre-tech/cassandre-trading-bot)：在几分钟内创建Java加密货币交易机器人，Starter负责处理交易所连接、账户、订单、交易和头寸，以便可以专注于构建策略。
...
* [ISO8583 Message Client](https://github.com/imohsenb/ISO8583-Message-Client-java)：一个轻量级ISO8583库，适用于Java和Android，基于构建器模式，并提供非常简单的使用。
...
* [SOFAJRaft](https://github.com/sofastack/sofa-jraft)：Raft共识算法的生产级Java实现，由蚂蚁开源。
...
* [jGroups Raft](https://github.com/jgroups-extras/jgroups-raft)：Raft共识协议在JGroups中的实现。
...
* [Thoth](https://github.com/MAIF/thoth)：该项目提供了在应用程序中实现事件源的工具。
...
* [Apache Causeway](https://github.com/apache/causeway)：用于使用Java快速开发领域驱动应用程序的框架。
...
* [Eclipse Capella](https://github.com/eclipse/capella)：基于模型的系统工程的开源解决方案。
...
* [Eclipse Transformer](https://github.com/eclipse/transformer)：提供了转换Java二进制文件(例如单个class文件和完整的JAR和WAR)的工具和运行时组件，将更改映射到Java包、类型名称和相关资源名称。
* [Butterfly](https://github.com/paypal/butterfly)：Butterfly是一种应用程序代码转换工具，通常用于执行自动化应用程序迁移、升级以及源代码和配置更改，由Paypal开源。
* [MigrationMiner](https://github.com/hussien89aa/MigrationMiner)：检测两个Java第三方库之间迁移代码的工具。
...
* [SnapKit](https://github.com/reportmill/SnapKit)：SnapKit是一个现代Java UI库和工具。
...
* [Griffon](https://github.com/griffon/griffon)：Griffon是JVM的桌面应用程序开发平台。
* [Matplotlib4j](https://github.com/sh0nk/matplotlib4j)：一个用于Java、Scala和Kotlin的简单绘图库。
...
* [Spring RCP](https://github.com/springrichclient/springrcp)：Spring RCP的使命是提供一种优雅的方式来构建高度可配置的、GUI标准-利用Spring更快地遵循富客户端应用程序框架以及丰富的UI工厂和支持类库。
...
* [JFreePDF](https://github.com/jfree/jfreepdf)：JFreePDF是Java平台的模块化库，它提供了生成PDF的Graphics2D API的实现。
* [Animated](https://github.com/iAmGio/animated)：JavaFX的现代动画库。
...
* [JObfuscator](https://www.pelock.com/products/jobfuscator)：源代码混淆器。
...
* [LWJGL](https://github.com/LWJGL/lwjgl3)：一个Java库，支持跨平台访问流行的原生API，可用于图形(OpenGL、Vulkan、bgfx)、音频(OpenAL、Opus)、并行计算(OpenCL、CUDA)和XR(OpenVR、LibOVR、OpenXR)应用程序。
...
* [Mini2Dx](https://github.com/mini2Dx/mini2Dx)：初学者友好、大师级的框架，用于快速原型设计和构建2D游戏。
...
* [SquidLib](https://github.com/yellowstonegames/SquidLib)：用于Java中的roguelike、角色扮演、策略和其他基于网格的游戏的有用工具。
* [VASSAL](https://github.com/vassalengine/vassal)：开源棋盘游戏引擎。
...
* [Compose Multiplatform](https://github.com/JetBrains/compose-multiplatform)：Kotlin的现代UI框架，使构建高性能且美观的用户界面变得轻松，由Jetbrains开源。
...
* [RIBs](https://github.com/uber/RIBs)：Uber的跨平台移动架构框架。
* [Multi-OS Engine](https://multi-os-engine.org/)：用于开发原生移动(iOS、Android等)应用程序的开源跨平台引擎。
* [MobileUI](https://mobileui.dev/)：用于开发具有Java和Kotlin原生UI的移动应用程序的跨平台框架。
...
* [Doppio](https://github.com/plasma-umass/doppio)：Doppio是一个兼容POSIX的运行时系统以及一个用TypeScript编写的JVM，也是马萨诸塞大学PLASMA小组的一个活跃的研究项目。
...
* [J2CL](https://github.com/google/j2cl)：一个功能强大、简单且轻量级的从Java到Closure风格JavaScript的转译器，由Google开源。
...
* [JLang](https://github.com/polyglot-compiler/JLang)：将Java程序提前编译为LLVM。
...
* [Polyglot](https://github.com/polyglot-compiler/polyglot)：Polyglot是Java编程语言的高度可扩展的编译器前端。
...
* [NetflixGraph](https://github.com/Netflix/netflix-graph)：NetflixGraph是一种紧凑的内存数据结构，用于表示有向图数据。
* [Slice](https://github.com/airlift/slice)：用于高效处理堆内存和堆外内存的Java库。
* [TomP2P](https://github.com/tomp2p/TomP2P)：一种基于P2P的高性能键值对存储库。
...
* [J2V8](https://github.com/eclipsesource/j2v8)：Google V8 JavaScript引擎的Java API。
* [Jssembly](https://github.com/dvx/jssembly)：Jssembly是一个允许你从Java执行本机汇编的库。
...
* [Domino JNA](https://github.com/klehmann/domino-jna)：使用JNA访问IBM/HCL Domino C API的Java项目。
...
* [BinDiff](https://github.com/google/bindiff)：Google开源的二进制文件比较工具，可以快速查找反汇编代码中的差异和相似之处。
...
* [Network-Connection](https://github.com/facebookarchive/network-connection-class)：在应用程序中监听当前的网络流量并对网络质量进行分类，Fackbook开源。
...
* [Commons-Networking](https://github.com/CiscoSE/commons-networking)：公共网络实用程序库，Cisco开源。
* [URNLib](https://github.com/slub/urnlib)：用于表示、解析和编码RFC 2141和RFC 8141中指定的URN的Java库，德累斯顿工业大学开源。
...
* [OneinStack](https://github.com/oneinstack/oneinstack)：PHP/Java部署工具。
...
* [JVMKill](https://github.com/airlift/jvmkill)：当JVM无法分配内存或创建线程时，强制终止JVM的代理。
* [Drip](https://github.com/ninjudd/drip)：快速JVM启动，无需持久JVM的麻烦。
* [Nailgun](https://martiansoftware.com/nailgun/)：Nailgun是一个客户端、协议和服务器，用于从命令行运行Java程序，而不会产生JVM启动开销。
...
* [Boxfuse](https://boxfuse.com/)：使用不可变基础设施的原则将JVM应用程序部署到AWS。
...
* [Apache SIS](https://github.com/apache/sis)：用于开发地理空间应用程序的Java语言库，该库是OGC GeoAPI 3.0.2接口的实现，可用于桌面或服务器应用程序。
...
* [DHIS 2](https://github.com/dhis2/dhis2-core)：DHIS 2是一个灵活的信息系统，用于数据捕获、管理、验证、分析和可视化。
...
* [Unfolding](https://github.com/tillnagel/unfolding)：用于在Processing和Java中创建交互式地图和地理可视化的库。
* [H2GIS](https://github.com/orbisgis/h2gis)：H2数据库的空间扩展。
...
* [OSHDB](https://github.com/GIScience/oshdb)：OpenStreetMap全历史数据的高性能时空数据分析平台。
...
* [Nunaliit](https://github.com/GCRC/nunaliit)：Nunaliit是一个用于创建交互式、数据驱动的网络地图集的系统，支持用户编辑文档和几何图形、集成多媒体、文档关系、灵活的数据模式、自我复制、动态推送更新到浏览器以获取新对象，以及基于平板电脑的在线/离线编辑和同步；由加拿大渥太华卡尔顿大学地理信息学和制图研究中心(GCRC)的一个团队开发。
...
* [Nom.Tam.Fits](https://github.com/nom-tam-fits/nom-tam-fits)：用于读写FITS文件的全功能100% Java库。
...
* [Parboiled](https://github.com/sirthias/parboiled)：提供基于解析表达式语法(PEG)的轻量级且易于使用但功能强大且优雅的任意输入文本解析。
* [Eclipse Xtext](https://github.com/eclipse/xtext)：一个用于开发编程语言和特定领域语言的框架。它涵盖了完整语言基础设施的所有方面，从解析器、链接器、编译器或解释器到针对Eclipse和基于Web的IDE的成熟的顶级IDE集成。
...
* [Sudachi](https://github.com/WorksApplications/Sudachi)：适用于商业的日语分词器。
...
* [JSIP](https://github.com/usnistgov/jsip)：Java SIP规范参考实现。
...
* [ECharts](https://github.com/abel533/ECharts)：这是一个针对ECharts 2.X版本的Java类库，实现了所有ECharts中的JSON结构对应的Java对象，并且可以很方便的创建Option、Series等。
...
* [Graphviz Java](https://github.com/nidi3/graphviz-java)：graphviz Java操作库。
* [Apache OpenMeetings](https://github.com/apache/openmeetings)：OpenMeetings是一个多语言可定制的视频会议和协作系统。
* [Opencast](https://github.com/opencast/opencast)：用于大规模自动视频捕获和分发的免费开源解决方案。
...
* [LightAdmin](https://github.com/la-team/light-admin)：通过为基于JPA的应用程序引入可插拔的完全可操作的数据管理后端来加速应用程序开发。
